      ...
      <RoomProvider
        ...
        initialStorage={{
          columns: new LiveMap([
            ...
            ["inbox", new LiveObject({ id: "inbox", title: "보관함", cardIds: new LiveList<string>(allCardIds) })],
          ] as any),
          ...
          cards: (new LiveMap<string, LiveObject<Card>>([
            ...
            ["h1", new LiveObject({ id: "h1", text: "아미아나 리조트 (오션뷰)", type: "travel", category: "hotel" } as any)],
            ["h2", new LiveObject({ id: "h2", text: "퓨전 리조트 (풀빌라)", type: "travel", category: "hotel" } as any)],
            ["h3", new LiveObject({ id: "h3", text: "버고 호텔 (시내 가성비)", type: "travel", category: "hotel" } as any)],
            ...
            ["s1", new LiveObject({ id: "s1", text: "롯데마트 기념품 (젤리, 커피)", type: "travel", category: "shopping" } as any)],
            ["s2", new LiveObject({ id: "s2", text: "담시장 원피스/라탄백", type: "travel", category: "shopping" } as any)],
            ["s3", new LiveObject({ id: "s3", text: "약국 쇼핑 (샤론파스, 바나나보트)", type: "travel", category: "shopping" } as any)],
          ]) as any),
          flightInfo: null,
        }}
      >
