...
const info: Record<string, RestaurantInfo> = {
    "로쿠린샤 도쿄역점": {
        photos: ["/images/tokyo/info/restaurants/udon.jpg"],
    ...
    "우오베이 시부야 도겐자카점": {
        photos: ["/images/tokyo/info/restaurants/sushi.jpg"],
    ...
    "규카츠 모토무라 신주쿠 미나미구치점": {
        photos: ["/images/tokyo/info/restaurants/tonkatsu.jpg"],
    ...
    "토리키조쿠 시부야 센터가이점": {
        photos: ["/images/tokyo/info/restaurants/yakitori.jpg"],
    ...
    "몬자 쿠라 츠키시마": {
        photos: ["/images/tokyo/info/restaurants/okonomiyaki.jpg"],
