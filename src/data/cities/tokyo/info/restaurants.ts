...
const info: Record<string, RestaurantInfo> = {
    "로쿠린샤 도쿄역점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Ramen_with_chashu_and_egg.jpg/640px-Ramen_with_chashu_and_egg.jpg"],
    ...
    "우오베이 시부야 도겐자카점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Sushi_platter.jpg/640px-Sushi_platter.jpg"],
    ...
    "규카츠 모토무라 신주쿠 미나미구치점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Gyukatsu.jpg/640px-Gyukatsu.jpg"],
    ...
    "긴자 바이린 본점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Tonkatsu_by_ayustety_in_Tokyo.jpg/640px-Tonkatsu_by_ayustety_in_Tokyo.jpg"],
    ...
    "츠지한 니혼바시 본점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Kaisendon.jpg/640px-Kaisendon.jpg"],
    ...
    "다이코쿠야 텐푸라 본점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Tendon_by_yoppy_in_Tokyo.jpg/640px-Tendon_by_yoppy_in_Tokyo.jpg"],
    ...
    "츠루톤탄 신주쿠점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Udon_noodle_soup.jpg/640px-Udon_noodle_soup.jpg"],
    ...
    "토리키조쿠 시부야 센터가이점": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Yakitori_by_Jeremy_Keith.jpg/640px-Yakitori_by_Jeremy_Keith.jpg"],
    ...
    "몬자 쿠라 츠키시마": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Monjayaki_001.jpg/640px-Monjayaki_001.jpg"],
    ...
    "소메타로 아사쿠사": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Okonomiyaki_001.jpg/640px-Okonomiyaki_001.jpg"],
    ...
    "긴자 우카이테이": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Wagyu_beef_steak.jpg/640px-Wagyu_beef_steak.jpg"],
    ...
    "나리사와": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Kaiseki_2017.jpg/640px-Kaiseki_2017.jpg"],
    ...
    "bills 오모테산도": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Souffle_pancakes.jpg/640px-Souffle_pancakes.jpg"],
    ...
    "오니기리 봉고": {
        photos: ["https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Onigiri_002.jpg/640px-Onigiri_002.jpg"],
