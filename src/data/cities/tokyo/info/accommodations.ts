...
const info: Record<string, AccommodationInfo> = {
    "호텔 메트로폴리탄 도쿄 마루노우치": {
        photos: ["/images/tokyo/info/accommodations/tokyo-station.jpg"],
    ...
    "JR 큐슈 호텔 블라섬 신주쿠": {
        photos: ["/images/tokyo/info/accommodations/shinjuku-skyline.jpg"],
    ...
    "호텔 그레이스리 신주쿠": {
        photos: ["/images/tokyo/info/accommodations/kabukicho.jpg"],
    ...
    "미츠이 가든 호텔 긴자 프리미어": {
        photos: ["/images/tokyo/info/accommodations/ginza-night.jpg"],
