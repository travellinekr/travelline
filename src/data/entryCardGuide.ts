...
export const ENTRY_CARD_DATA: Record<string, EntryCardInfo> = {
    ...
    japan: {
        country: "🇯🇵 일본",
        status: "Visit Japan Web 사전등록 권장 · 90일 무비자",
        statusEmoji: "📱",
        updatedAt: "2026-07-08",
        source: "https://vjw-lp.digital.go.jp/ko/",
        details: [
            { label: "입국신고서", value: "📱 Visit Japan Web(VJW) 사전등록 권장 · 현장 종이 입국기록카드 작성도 가능" },
            { label: "세관신고서", value: "📱 VJW에서 휴대품·별송품 신고 등록 후 QR 제시 가능 · 종이 세관신고서 대체 가능" },
            { label: "비자", value: "대한민국 일반여권 관광 목적 90일 무비자" },
            { label: "여권 유효기간", value: "체류기간 동안 유효 필요 (잔여기간이 짧으면 항공사·입국심사 확인 권장)" },
            { label: "필수서류", value: "여권, 왕복/출국 항공권, 일본 내 숙소명·주소·전화번호, 체류 일정" },
            { label: "VJW 필요정보", value: "이메일 계정, 여권 정보, 항공편명, 도쿄 체류지 주소, 직업·방문목적, 세관 신고 항목" },
            { label: "결과", value: "입국심사·세관신고용 통합 QR 코드 발급 → 공항에서 제시" },
        ],
        warnings: [
            "⚠️ Visit Japan Web은 입국심사·세관신고를 빠르게 처리하기 위한 사전등록 서비스입니다. 공항 혼잡 시 QR 저장/캡처를 미리 준비하세요.",
            "⚠️ 도쿄 호텔·에어비앤비 주소와 연락처를 영문/일문 표기로 미리 준비하면 작성이 빠릅니다.",
        ],
        process: [
            { step: 1, title: "VJW 공식 사이트 접속", description: "vjw-lp.digital.go.jp/ko/ 또는 vjw.digital.go.jp 접속 → 계정 생성/로그인" },
            { step: 2, title: "이용자·여권 정보 등록", description: "여권 영문 이름, 생년월일, 국적, 여권번호를 여권과 동일하게 입력" },
            { step: 3, title: "입국·귀국 예정 등록", description: "도착 예정일, 항공편명, 도쿄 내 숙소명·주소·전화번호 입력" },
            { step: 4, title: "입국심사 정보 입력", description: "방문 목적, 체류 예정 기간, 일본 내 연락처 등 외국인 입국기록 항목 작성" },
            { step: 5, title: "휴대품·별송품 신고", description: "반입 물품, 면세 범위, 별송품 여부 등 세관 신고 항목 작성" },
            { step: 6, title: "QR 코드 저장", description: "입국심사·세관신고용 QR을 캡처/저장하고, 인터넷이 안 될 때를 대비해 오프라인에서도 확인 가능하게 준비" },
        ],
        links: [
            { label: "Visit Japan Web 공식 안내", url: "https://vjw-lp.digital.go.jp/ko/", type: "official", description: "일본 디지털청 Visit Japan Web 공식 안내 페이지" },
            { label: "Visit Japan Web 로그인", url: "https://www.vjw.digital.go.jp/", type: "official", description: "입국심사·세관신고 정보 등록 및 QR 코드 발급" },
            { label: "Visit Japan Web 한국어 조작설명서", url: "https://www.vjw.digital.go.jp/manual/main/visitjapanweb_manual_ko.html", type: "official", description: "계정 생성, 입국 예정 등록, QR 코드 표시 방법 공식 매뉴얼" },
            { label: "도쿄 VJW 작성방법 블로그", url: "https://blog.naver.com/peseaello/223518862387", type: "blog", description: "도쿄 여행 기준 Visit Japan Web 입국신고서·세관신고서 작성 예시" },
        ],
    },
    singapore: {
        country: "🇸🇬 싱가포르",
